...
HD_PWD='C:/Users/andry/Desktop/Digitale/Vivado/ConvSimd_FINAL/ConvSimd/ConvSimd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CONV_SIMD_3X3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CONV_SIMD_3X3.tcl -notrace
