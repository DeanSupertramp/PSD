...
HD_PWD='C:/Users/andry/Desktop/Digitale/Vivado/ConvSimd_FINAL/ConvSimd/ConvSimd.runs/Memory_in_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Memory_in.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Memory_in.tcl
