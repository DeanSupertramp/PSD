...
HD_PWD='C:/Users/andry/Desktop/Digitale/Vivado/ConvSimd_FINAL/ConvSimd/ConvSimd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CONV_SIMD_3X3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CONV_SIMD_3X3.tcl
