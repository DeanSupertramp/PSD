...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot Memory_in xil_defaultlib.Memory_in -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Memory_in -key {Behavioral:sim_1:Functional:Memory_in} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Memory_in.wdb xsim.dir)
