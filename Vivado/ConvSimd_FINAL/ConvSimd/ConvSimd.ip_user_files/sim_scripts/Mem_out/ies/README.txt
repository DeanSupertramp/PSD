...
#
# Generated by export_simulation on Sun Oct 17 12:34:59 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './Mem_out.sh' script.

./Mem_out.sh -reset_run
...
./Mem_out.sh -noclean_files

For more information on the script, please type './Mem_out.sh -help'.
