...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot Mem_out xil_defaultlib.Mem_out -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Mem_out -key {Behavioral:sim_1:Functional:Mem_out} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Mem_out.wdb xsim.dir)
